    ...
    <section className="relative bg-[#0096FF] mt-[6.25rem] py-[3rem] sm:py-[4rem] md:py-[5rem] lg:py-[6rem] xl:py-[8rem] overflow-hidden font-[Helvetica,Arial,sans-serif]">
      ...
      <div className="max-w-[90rem] mx-auto px-[1rem] sm:px-[1.5rem] md:px-[3rem] lg:px-[5rem] xl:px-[6rem] relative z-10">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-[3rem] lg:gap-[4rem] xl:gap-[5rem] items-center">
          ...
          <div className="relative w-full order-1 lg:order-2 flex items-center justify-center py-[2rem]">
            <QRCodeContainer />
          </div>
          ...
          <StarsDecorationWhite className="top-[17rem] right-[23rem] w-[3rem] h-[3.5rem] max-[424px]:top-[17rem] max-[424px]:right-[20rem] md:right-[44rem] md:top-[28rem] lg:hidden" />
          ...
          <div className="relative space-y-[1.5rem] sm:space-y-[2rem] lg:space-y-[2rem] order-2 lg:order-1 w-full pt-[4rem] lg:pt-[0]">
            ...
            <p className="text-[0.875rem] sm:text-[1rem] md:text-[1.125rem] lg:text-[1.25rem] xl:text-[1.5rem] font-normal leading-[1.5] sm:leading-[1.6] lg:leading-[1.5] xl:leading-[2.25rem] text-center lg:text-left text-[#00212A] max-w-[35rem] lg:max-w-[40rem] mx-auto lg:mx-0">
              Chat with friends. Support local sellers. Shop smarter. All in one app made for non-Africans.
            </p>
