  ...
  return (
    <section className="relative bg-white pt-[8rem] lg:pt-[18rem] pb-[3rem] sm:pb-[4rem] md:pb-[5rem] lg:pb-[6rem] xl:pb-[8rem] overflow-hidden font-[Helvetica,Arial,sans-serif]">
      ...
      <img 
        ...
        alt="decorative curve" 
        className="lg:block absolute pointer-events-none z-0 w-[6rem] h-[1rem] lg:w-[11.25rem] lg:h-[2.1875rem] top-[17.5rem] left-[20rem] lg:top-[35rem] lg:left-[46rem] xl:top-[35rem] xl:left-[60rem] 2xl:left-[100rem]"
      />
