          ...
          <div className={`relative space-y-[1.5rem] sm:space-y-[2rem] lg:space-y-[2rem] ${contentOrderClasses} w-full`}>
            ...
            {features.length > 0 && (
              <div className="flex justify-center lg:justify-start">
                <ul className="space-y-[0.75rem] sm:space-y-[1rem] text-[0.875rem] sm:text-[1rem] md:text-[1.125rem] lg:text-[1.25rem] font-normal leading-[1.5] text-left text-[#00212A]">
                  {features.map((feature, index) => (
                    <li key={index} className="flex items-start">
                      <span className="text-[#0096FF] mr-[0.5rem] sm:mr-[0.75rem] flex-shrink-0 mt-[0.25rem]">•</span>
                      <span>{feature}</span>
                    </li>
                  ))}
                </ul>
            ...
            {/* Footer Text */}
            {footerText && (
              <p className="text-[0.75rem] sm:text-[0.875rem] md:text-[1rem] lg:text-[1.125rem] font-normal leading-[1.5] sm:leading-[1.6] text-center lg:text-left text-[#00212A] max-w-[35rem] lg:max-w-[40rem] mx-auto lg:mx-0">
                {footerText}
              </p>
            )}
          </div>
